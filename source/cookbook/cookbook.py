...
class Cookbook_Home_Layout(RelativeLayout):
	def __init__(self, recipe_manager, cookbook_data, shopping_cookbook_data, screenmanager, **kwargs):
		...
		VD = view.View_Nodes_Scroll(cookbook_data, **kwargs)
		self.add_widget(VD)
		...
		RB = pu.Remove_From_Database_Button(self, VD, cookbook_data, **kwargs)
		self.add_widget(RB)
...
class Add_Shopping_Recipe_Button(su.Screen_Button):
...
class To_Recipe_Home(su.Screen_Button):
